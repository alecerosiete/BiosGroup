            ...
            <tbody>
                ...
                $html = "";
                       foreach ($a_category as $category) {
                            ...
                            $html .= "<td style='text-align: center'><input type='button' class='btn' value='".$label."' id='activate_".$category['id']."' onclick='(btn_active_category_electromedicina(".$category['id']."))'/></td>";
